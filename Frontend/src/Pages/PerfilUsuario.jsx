                          ...
                          return (
                            <div key={id} className={`donation-item list`}>
                              <DonationCard
                                ...
                                category={
                                  donacion.category || donacion.categoria
                                }
                                location={location}
                  ...
                  onConfirm={async () => {
                    ...
                    try {
                      ...
                      const filteredOptim = prevTrans.filter((t) => {
                        ...
                        if (idKey && transIdOptim)
                          return idKey !== transIdOptim;
                        return !(
                      ...
                      if (usuarioActual && usuarioActual.id) {
                        ...
                        if (resUser.ok) {
                          ...
                          const serverTrans = Array.isArray(
                            userBD?.transacciones
                          )
                            ? userBD.transacciones
                            : [];
                          ...
                          const filtered = mergedTrans.filter((t) => {
                            ...
                            if (tipo === "donacion" || tipo === "donación") {
                              const donationRef =
                                ...
                                t.productoId;
                              return !(
                                donationRef && donationRef === donationId
                              );
                            }
                            return true;
                          });

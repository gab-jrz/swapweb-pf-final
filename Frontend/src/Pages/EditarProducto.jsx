...
const EditarProducto = () => {
  ...
  const totalCaracteres = (producto.caracteristicas || []).reduce(
    (acc, c) => acc + c.length,
    0
  );
  ...
  const handleSubmit = async (e) => {
    ...
    const imagesBase64OrUrl = await Promise.all(
            ...
            <div className="form-group">
              ...
              >
                ...
                <div className="upload-placeholder">
                  ...
                  <p>
                    Arrastra y suelta hasta 3 imágenes aquí o haz clic para
                    seleccionar
                  </p>
            ...
            <form onSubmit={handleSubmit} className="form-editar-producto">
              ...
              <div className="form-group">
                <label>
                  ...
                  >
                    (opcional, máx 15 ítems/1000 caracteres)
                  </span>
                </label>
                <div className="caracteristicas-checklist">
                  <div className="caracteristicas-input-row">
                    <input
                      ...
                      disabled={
                        (producto.caracteristicas || []).length >= 15 ||
                    ...
                    <button
                      ...
                      disabled={
                        !caracteristicaInput.trim() ||
                        (producto.caracteristicas || []).length >= 15 ||
                        totalCaracteres + caracteristicaInput.length > 1000
                      }
                    >
                      +
                    </button>
                    ...
                    {(producto.caracteristicas || []).map((item, idx) => (
                      <div className="caracteristica-item" key={idx}>
                        ...
                        <input
                          ...
                          maxLength={200}
                          onChange={(e) =>
                            handleEditCaracteristica(idx, e.target.value)
                          }
                  ...
                  <div className="caracteristicas-limits">
                    <span>
                      {(producto.caracteristicas || []).length}/15 ítems
                    </span>{" "}
                    | <span>{totalCaracteres}/1000 caracteres</span>
                  </div>
                  {caracteristicasError && (
                    <div className="caracteristicas-error">
                      {caracteristicasError}
                    </div>
                  )}
                </div>
